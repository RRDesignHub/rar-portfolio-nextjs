export default function MagicButton({
  ...
  return (
    <button className="relative inline-flex h-12 overflow-hidden rounded-xl p-[1px] ">
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-[#1f0f1d] px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">
        {title}
      </span>
    </button>
  );
